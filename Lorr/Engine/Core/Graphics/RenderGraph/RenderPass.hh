...
struct RenderPassAttachment
{
    ...
    bool IsWrite() { return m_Access & LR_MEMORY_ACCESS_IMAGE_WRITE_UTL; }
...
struct RenderPass
{
    virtual void Setup(VKContext *pContext) = 0;
...
using RenderPassSetupFn = eastl::function<void(VKContext *, _Data &, GraphicsRenderPass &)>;
template<typename _Data>
...
{
    void Setup(VKContext *pContext) override
    {
        ZoneScoped;
