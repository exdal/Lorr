...
enum MemoryAccess : u32
{
    ...
    // Utility flags
    LR_MEMORY_ACCESS_IMAGE_READ_ALL = LR_MEMORY_ACCESS_SHADER_READ | LR_MEMORY_ACCESS_RENDER_TARGET_READ
                                      | LR_MEMORY_ACCESS_DEPTH_STENCIL_READ | LR_MEMORY_ACCESS_MEMORY_READ,
    LR_MEMORY_ACCESS_IMAGE_WRITE_ALL = LR_MEMORY_ACCESS_SHADER_WRITE | LR_MEMORY_ACCESS_RENDER_TARGET_WRITE
                                       | LR_MEMORY_ACCESS_DEPTH_STENCIL_WRITE | LR_MEMORY_ACCESS_MEMORY_WRITE,
};
...
struct PipelineBarrier
{
    ...
    MemoryAccess m_CurrentAccess = LR_MEMORY_ACCESS_NONE;
    MemoryAccess m_NextAccess = LR_MEMORY_ACCESS_NONE;
};
