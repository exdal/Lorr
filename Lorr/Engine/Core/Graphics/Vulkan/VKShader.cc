    ...
    ShaderCompileDesc *pDesc, BufferReadStream &buffer, u32 *&pDataOut, u32 &dataSizeOut)
{
    ...
    glslang_spv_options_t spvOptions = {
        .generate_debug_info = ENABLE_IF_HAS(LR_SHADER_FLAG_GENERATE_DEBUG_INFO),
        .strip_debug_info = !ENABLE_IF_HAS(LR_SHADER_FLAG_SKIP_OPTIMIZATION),
        .disable_optimizer = ENABLE_IF_HAS(LR_SHADER_FLAG_SKIP_OPTIMIZATION),
        .validate = !ENABLE_IF_HAS(LR_SHADER_FLAG_SKIP_VALIDATION),
    };
