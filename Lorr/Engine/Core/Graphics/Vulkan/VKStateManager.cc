...
namespace lr::Graphics
{
    ...
    void APIStateManager::Init(VKAPI *pAPI)
    {
        ...
        m_pAPI->BeginPipelineBuildInfo(graphicsBuildInfo, nullptr);
        ...
        m_pAPI->EndPipelineBuildInfo(graphicsBuildInfo, &m_PresentPipeline, { &m_Camera3DDescriptor });
        ...
        m_pAPI->EndPipelineBuildInfo(graphicsBuildInfo, &m_UIPipeline, { &m_Camera2DDescriptor });
