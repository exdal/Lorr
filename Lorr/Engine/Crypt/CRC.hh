...
u32 CRC32String(CRCHashFn pHashFn, std::string_view str);
// As a default, will always select `CRC32DataAligned`
u32 CRC32String(std::string_view str);

constexpr u32 CRC32DataSV(std::string_view str)
{
    u32 hash = ~0;
    u64 offset = 0;
...
#define CRC32HashOf(x) (std::integral_constant<u32, lr::Hash::CRC32DataSV(x)>::value)
