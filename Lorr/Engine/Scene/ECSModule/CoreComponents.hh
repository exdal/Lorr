...
ECS_COMPONENT_BEGIN(Transform)
    ...
    ECS_COMPONENT_MEMBER(rotation, glm::quat, glm::quat::wxyz(1.0f, 0.0f, 0.0f, 0.0f))
...
ECS_COMPONENT_BEGIN(DirectionalLight)
    ...
    ECS_COMPONENT_MEMBER(clipmap_count, u32, 4)
    ECS_COMPONENT_MEMBER(clipmap_selection_bias, f32, 2.5f)
    ECS_COMPONENT_MEMBER(first_clipmap_width, f32, 10.0f)
    ECS_COMPONENT_MEMBER(first_clipmap_height_offset, f32, 5.0f)
    ECS_COMPONENT_MEMBER(fixed_z_length, bool, true)
    ECS_COMPONENT_MEMBER(z_length, f32, 1000.0f)
