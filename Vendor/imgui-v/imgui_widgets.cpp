...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
    ...
    if (flags & ImGuiColorEditFlags_PickerHueWheel)
    {
        ...
        draw_list->PrimWriteVtx(tra, uv_white, hue_color32);
        draw_list->PrimWriteVtx(trb, uv_white, hue_color32);
        draw_list->PrimWriteVtx(trc, uv_white, col_white);
        draw_list->PrimWriteVtx(tra, uv_white, 0);
        draw_list->PrimWriteVtx(trb, uv_white, col_black);
        draw_list->PrimWriteVtx(trc, uv_white, 0);
