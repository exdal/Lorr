package("slang-lorr")
    ...
    add_versions("v2024.11.1", "c46ca4cfeff2c78078aa3c4014cd6b0341ee01fc")
    ...
    add_patches("v2024.11.1", path.join(os.scriptdir(), "patches", "2024.11.1", "clang.patch"), "5cc62201c72ae8dd86b1cfa2e596eaf039d020156a9fe8fce3c40388dd78aebb")
    add_patches("v2024.13",   path.join(os.scriptdir(), "patches", "2024.13",   "slang.patch"), "b56696858d3a58fe4cffc8f82392a2aa54c2b8b50b40296e5598cfb7f7f07bcc")
    ...
    on_install("windows|x64", "macosx", "linux|x86_64", function (package)
        ...
        table.insert(configs, "-DSLANG_ENABLE_ASAN=OFF")
